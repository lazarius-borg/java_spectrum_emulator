...
public class TapeLoadingTest {
    ...
    void testTapeLoadingRoutine() throws Exception {
        ...
        machine.getKeyboard().setKeyPressed(com.spectrum.io.Keyboard.ROW_ENTER_L_K_J_H, 0, true);
        for (int f = 0; f < 10; f++) {
            machine.stepFrame();
        }
        machine.getKeyboard().setKeyPressed(com.spectrum.io.Keyboard.ROW_ENTER_L_K_J_H, 0, false);
